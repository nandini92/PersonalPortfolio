    ...
    <Wrapper id="about">
      <Content>
        ...
        <Title>A leap into the future...</Title>
          <p>After 6 years in the finance industry as a support engineer, I decided to make the leap to become a Full-Stack Developer. I made this decision in order to contribute meaningfully towards technological solutions.</p>
          <p>Although I have just begun my journey in development,  my years in operations have exposed me to various technologies. In Level 2, I have  worked with everything from communications to debugging to security.  Below are just a few core capabilities that I bring to the table:</p>
          <ul>
